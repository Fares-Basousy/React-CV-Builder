...
function Info({onChange}) {
  ...
  const onChangePicture = e => {
    ...
    <h3 className='mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white text-center '>Personal Indivation</h3>
    <img className= {"float-right w-32 h-32 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500 ml-auto " + display} src={imgData} />
    <br />
    <br />
